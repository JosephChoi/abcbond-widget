...
`;function i(a,t={}){let e=document.createElement(a);return Object.keys(t).forEach(n=>{n==="className"?e.className=t[n]:n==="innerHTML"?e.innerHTML=t[n]:n==="style"&&typeof t[n]=="object"?Object.assign(e.style,t[n]):n==="dataset"?Object.keys(t[n]).forEach(o=>{e.dataset[o]=t[n][o]}):e.setAttribute(n,t[n])}),e}var R="https://abcbond-api.sixman-joseph.workers.dev";function j(){try{let a=localStorage.getItem("widget-state");if(a)return JSON.parse(a).token||null}catch(a){console.warn("Failed to get auth token:",a)}return null}async function T(a,t={}){try{let e=j(),n={"Content-Type":"application/json",...t.headers};e&&(n.Authorization=`Bearer ${e}`);let o=await fetch(`${R}${a}`,{...t,headers:n});if(!o.ok){let s=await o.json().catch(()=>({}));throw new Error(s.message||`HTTP error! status: ${o.status}`)}return await o.json()}catch(e){throw console.error("API call failed:",e),e}}async function E(){try{let a=await T("/user-investments/my");return a.success?a.data:[]}catch(a){throw console.error("Failed to fetch my investments:",a),a}}async function H(a){try{let t=await T(`/investments/${a}`);return t.success?t.data:null}catch(t){throw console.error("Failed to fetch investment detail:",t),t}}async function M(a,t){try{let e=await T("/auth/login",{method:"POST",body:JSON.stringify({username:a,password:t})});return e.success?{token:e.token,user:e.user}:null}catch(e){throw console.error("Login failed:",e),e}}var b=class{constructor(t={}){this.props=t,this.onLoginSuccess=t.onLoginSuccess||(()=>{}),this.state=t.state,this.error=null,this.isLoading=!1}render(){let t=i("div",{className:"login-container"}),e=i("div",{className:"login-box"}),n=i("div",{className:"login-header"});n.innerHTML=`
    ...
    `;let l=s.querySelector("tbody"),h=0;return n.forEach(c=>{h+=c.amount;let g=i("tr");g.innerHTML=`
        <td>${c.month}</td>
        <td class="amount">${c.amount.toLocaleString("ko-KR")}\uC6D0</td>
        <td class="cumulative">${h.toLocaleString("ko-KR")}\uC6D0</td>
      `,l.appendChild(g)}),t.appendChild(s),t}renderPropertyInfo(){let t=i("div",{className:"investment-section"}),e=i("h2",{className:"section-title",innerHTML:"\uBB3C\uAC74 \uC815\uBCF4"});t.appendChild(e);let n=this.investment.details||{};if(Object.keys(n).length===0){let l=i("p",{innerHTML:"\uBB3C\uAC74 \uC815\uBCF4\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.",style:"text-align: center; padding: 40px; color: #6c757d;"});return t.appendChild(l),t}let o=i("table",{className:"property-info-table"}),r=[["\uAC74\uBB3C \uC720\uD615",n.buildingType||n.building_type||"-"],["\uC804\uCCB4 \uC138\uB300\uC218",n.totalUnits?n.totalUnits+"\uC138\uB300":n.total_units?n.total_units+"\uC138\uB300":"-"],["\uC900\uACF5\uC5F0\uB3C4",n.buildYear?n.buildYear+"\uB144":n.build_year?n.build_year+"\uB144":"-"],["\uC804\uC6A9\uBA74\uC801",n.area||"-"],["\uCE35\uC218",n.floor||"-"],["\uBC29\uD5A5",n.direction||"-"],["\uC8FC\uCC28",n.parking||"-"],["\uB09C\uBC29",n.heating||"-"]],s=i("tbody");return r.forEach(([l,h])=>{let c=i("tr");c.innerHTML=`
        <th>${l}</th>
        <td>${h}</td>
      `,s.appendChild(c)}),o.appendChild(s),t.appendChild(o),t}renderRegistrationDocument(){let t=i("div",{className:"registration-document-section"}),e=i("h2",{className:"section-title",innerHTML:"\uB4F1\uAE30\uBD80\uB4F1\uBCF8"});t.appendChild(e);let n=this.investment.registrationDocument||this.investment.registration_document;if(!n){let p=i("p",{innerHTML:"\uB4F1\uAE30\uBD80\uB4F1\uBCF8 \uC815\uBCF4\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.",style:"text-align: center; padding: 40px; color: #6c757d;"});return t.appendChild(p),t}let o=i("div",{className:"reg-issue-date"});o.innerHTML=`<strong>\uBC1C\uAE09\uC77C\uC790:</strong> ${n.issueDate}`,t.appendChild(o);let r=i("div",{className:"reg-section"}),s=i("h3",{className:"reg-section-title",innerHTML:"\uD45C\uC81C\uBD80 (\uBB3C\uAC74 \uC815\uBCF4)"});r.appendChild(s);let l=i("table",{className:"reg-table"}),h=[["\uC18C\uC7AC\uC9C0",n.propertyInfo.address],["\uAC74\uBB3C\uBA85",n.propertyInfo.buildingName],["\uAC74\uBB3C \uC720\uD615",n.propertyInfo.buildingType],["\uAD6C\uC870",n.propertyInfo.structure],["\uCE35\uC218",n.propertyInfo.floors],["\uC804\uCCB4 \uBA74\uC801",n.propertyInfo.totalArea],["\uC900\uACF5\uC77C",n.propertyInfo.buildDate]],c=i("tbody");h.forEach(([p,m])=>{let d=i("tr");d.innerHTML=`
        <th>${p}</th>
        <td>${m}</td>
      `,c.appendChild(d)}),l.appendChild(c),r.appendChild(l),t.appendChild(r);let g=i("div",{className:"reg-section"}),$=i("h3",{className:"reg-section-title",innerHTML:"\uAC11\uAD6C (\uC18C\uC720\uAD8C \uC815\uBCF4)"});g.appendChild($);let N=i("table",{className:"reg-table"}),P=[["\uC18C\uC720\uC790",n.ownershipInfo.owner],["\uB4F1\uAE30\uC77C\uC790",n.ownershipInfo.registrationDate],["\uB4F1\uAE30\uC6D0\uC778",n.ownershipInfo.registrationCause],["\uC9C0\uBD84",n.ownershipInfo.shareRatio]],z=i("tbody");if(P.forEach(([p,m])=>{let d=i("tr");d.innerHTML=`
        <th>${p}</th>
        <td>${m}</td>
      `,z.appendChild(d)}),N.appendChild(z),g.appendChild(N),t.appendChild(g),n.rightsInfo&&n.rightsInfo.length>0){let p=i("div",{className:"reg-section"}),m=i("h3",{className:"reg-section-title",innerHTML:"\uAD8C\uB9AC\uC0AC\uD56D (\uAC11\uAD6C)"});p.appendChild(m),n.rightsInfo.forEach((d,k)=>{let v=i("div",{className:"reg-right-box"});v.innerHTML=`
        ...
        `,p.appendChild(v)}),t.appendChild(p)}if(n.restrictionsInfo&&n.restrictionsInfo.length>0){let p=i("div",{className:"reg-section"}),m=i("h3",{className:"reg-section-title",innerHTML:"\uC744\uAD6C (\uC81C\uD55C\uC0AC\uD56D)"});p.appendChild(m),n.restrictionsInfo.forEach((d,k)=>{let v=i("div",{className:"reg-restriction-box"});v.innerHTML=`
        ...
        `,p.appendChild(v)}),t.appendChild(p)}return t}};var x=class{constructor(t={}){this.routes=t,this.currentRoute=null,this.currentPath=null,this.pathParams={},this.isNavigating=!1,this.loadingTimeout=null,this.beforeNavigate=null,this.handlePopState=this.handlePopState.bind(this),window.addEventListener("popstate",this.handlePopState),this.handleHashChange=this.handleHashChange.bind(this),window.addEventListener("hashchange",this.handleHashChange)}addRoute(t,e){this.routes[t]=e}addRoutes(t){this.routes={...this.routes,...t}}getHash(){return window.location.hash.slice(1)||"/"}extractParams(t,e){let n=t.split("/"),o=e.split("/");if(n.length!==o.length)return null;let r={};for(let s=0;s<n.length;s++)if(n[s].startsWith(":")){let l=n[s].slice(1);r[l]=decodeURIComponent(o[s])}else if(n[s]!==o[s])return null;return r}matchRoute(t){if(this.routes[t])return{handler:this.routes[t],params:{}};for(let e in this.routes){if(e==="*")continue;let n=this.extractParams(e,t);if(n!==null)return{handler:this.routes[e],params:n}}return this.routes["*"]?{handler:this.routes["*"],params:{}}:null}async handleRoute(){if(this.isNavigating)return;let t=this.getHash(),e=this.matchRoute(t);if(!e){console.warn("No route handler found for:",t);return}this.isNavigating=!0;try{this.loadingTimeout=setTimeout(()=>{this.showLoadingIndicator()},1e3),this.beforeNavigate&&await this.beforeNavigate(t,e.params),clearTimeout(this.loadingTimeout),this.hideLoadingIndicator(),this.currentRoute=t,this.currentPath=t,this.pathParams=e.params,e.handler(e.params)}catch(n){console.error("Route handling error:",n),clearTimeout(this.loadingTimeout),this.hideLoadingIndicator()}finally{this.isNavigating=!1}}handlePopState(){this.handleRoute()}handleHashChange(){this.handleRoute()}showLoadingIndicator(){if(document.querySelector(".router-loading-indicator"))return;let e=document.createElement("div");e.className="router-loading-indicator",e.innerHTML='<div class="spinner"></div>',document.body.appendChild(e)}hideLoadingIndicator(){let t=document.querySelector(".router-loading-indicator");t&&t.remove()}setBeforeNavigate(t){this.beforeNavigate=t}navigate(t,e={}){window.history.pushState(e,"",`#${t}`),this.handleRoute()}redirect(t,e={}){window.history.replaceState(e,"",`#${t}`),this.handleRoute()}back(){window.history.back()}forward(){window.history.forward()}getCurrentRoute(){return{fullPath:this.currentRoute,path:this.currentPath,params:this.pathParams,hash:this.getHash()}}getParam(t){return t?this.pathParams[t]:{...this.pathParams}}isRoute(t){return this.currentPath===t}destroy(){window.removeEventListener("popstate",this.handlePopState),window.removeEventListener("hashchange",this.handleHashChange)}init(){this.handleRoute()}};var w=class{constructor(){this.state={user:null,token:null,currentView:null},this.listeners=new Map}getState(t){return t?this.state[t]:{...this.state}}setState(t){let e={...this.state};this.state={...this.state,...t},Object.keys(t).forEach(n=>{this.notify(n,this.state[n],e[n])}),this.notify("*",this.state,e)}subscribe(t,e){return this.listeners.has(t)||this.listeners.set(t,[]),this.listeners.get(t).push(e),()=>{let n=this.listeners.get(t),o=n.indexOf(e);o>-1&&n.splice(o,1)}}notify(t,e,n){(this.listeners.get(t)||[]).forEach(r=>{r(e,n)})}setUser(t,e=null){this.setState({user:t,token:e})}getUser(){return this.state.user}getToken(){return this.state.token}setToken(t){this.setState({token:t})}isAuthenticated(){return this.state.user!==null&&this.state.token!==null}logout(){this.setState({user:null,token:null});try{localStorage.removeItem("widget-state")}catch(t){console.warn("Failed to remove state from localStorage:",t)}this.notify("auth:logout")}setCurrentView(t){this.setState({currentView:t})}reset(){this.state={user:null,token:null,currentView:null},this.notify("*",this.state,{})}saveToStorage(){try{localStorage.setItem("widget-state",JSON.stringify({user:this.state.user,token:this.state.token}))}catch(t){console.warn("Failed to save state to localStorage:",t)}}loadFromStorage(){try{let t=localStorage.getItem("widget-state");if(t){let e=JSON.parse(t);this.setState({user:e.user||null,token:e.token||null})}}catch(t){console.warn("Failed to load state from localStorage:",t)}}},I=null;function C(){return I||(I=new w),I}var y=class{constructor(t,e={}){this.container=t||"#widget-root",this.config=e,this.currentView=null,this.state=C(),this.router=new x,this.setupRoutes(),this.init()}setupRoutes(){this.router.addRoutes({"/":()=>this.showInvestmentList(),"/investment/:id":t=>this.showInvestmentDetail(t),"*":()=>this.showInvestmentList()})}init(){if(console.log("Widget initialized with config:",this.config),!this.getContainer()){console.error("Container not found:",this.container);return}if(this.config.persistState!==!1&&this.state.loadFromStorage(),this.config.persistState!==!1&&this.state.subscribe("user",()=>{this.state.saveToStorage()}),this.state.subscribe("auth:logout",()=>{this.showLogin()}),!this.state.isAuthenticated()){this.showLogin();return}this.router.setBeforeNavigate(async(e,n)=>{if(!this.state.isAuthenticated()){this.showLogin();return}await this.preloadPage(e,n)}),this.router.init()}async preloadPage(t,e){if(t==="/")await new u({state:this.state}).loadInvestments();else if(t.startsWith("/investment/")){let n=parseInt(e.id);n&&await new f({investmentId:n,state:this.state}).loadInvestment()}}getContainer(){return typeof this.container=="string"?document.querySelector(this.container):this.container}showLogin(){let t=this.getContainer();if(!t)return;this.state.setCurrentView("login");let n=new b({state:this.state,onLoginSuccess:o=>{this.state.setUser(o.user,o.token),this.config.persistState!==!1&&this.state.saveToStorage(),this.router.navigate("/")}}).render();this.transitionToPage(t,n)}showInvestmentList(){let t=this.getContainer();if(!t)return;this.state.setCurrentView("investment-list");let n=new u({state:this.state,onInvestmentClick:o=>{this.router.navigate(`/investment/${o.id}`)}}).render();this.transitionToPage(t,n)}showInvestmentDetail(t){let e=this.getContainer();if(!e)return;let n=parseInt(t.id);if(!n){console.error("Investment ID is required"),this.router.navigate("/");return}this.state.setCurrentView("investment-detail");let r=new f({investmentId:n,state:this.state,onBack:()=>{this.router.back()}}).render();this.transitionToPage(e,r)}transitionToPage(t,e){let n=t.firstElementChild;e.style.opacity="0",e.style.transition="opacity 0.05s ease-in-out",n?(n.style.transition="opacity 0.05s ease-in-out",n.style.opacity="0",setTimeout(()=>{t.innerHTML="",t.appendChild(e),setTimeout(()=>{e.style.opacity="1"},10)},50)):(t.appendChild(e),setTimeout(()=>{e.style.opacity="1"},10))}getCurrentRoute(){return this.router.getCurrentRoute()}navigate(t,e={}){this.router.navigate(t,e)}getState(t){return this.state.getState(t)}destroy(){this.router.destroy(),this.config.resetOnDestroy&&this.state.reset();let t=this.getContainer();t&&(t.innerHTML=""),this.currentView=null}};var L=class a{constructor(t={}){this.props=t,this.title=t.title||"",this.content=t.content||"",this.onClose=t.onClose||(()=>{}),this.overlay=null}render(){this.overlay=i("div",{className:"widget-modal-overlay"});let t=i("div",{className:"widget-modal"}),e=i("button",{className:"widget-modal-close",innerHTML:"\xD7"});e.addEventListener("click",()=>this.close());let n=i("h2",{innerHTML:this.title,style:"margin-top: 0;"}),o=i("div",{className:"widget-modal-content"});return typeof this.content=="string"?o.innerHTML=this.content:o.appendChild(this.content),t.appendChild(e),this.title&&t.appendChild(n),t.appendChild(o),this.overlay.appendChild(t),this.overlay.addEventListener("click",r=>{r.target===this.overlay&&this.close()}),this.handleEscKey=r=>{r.key==="Escape"&&this.close()},document.addEventListener("keydown",this.handleEscKey),this.overlay}open(){let t=this.render();document.body.appendChild(t)}close(){this.overlay&&this.overlay.parentNode&&this.overlay.parentNode.removeChild(this.overlay),document.removeEventListener("keydown",this.handleEscKey),this.onClose()}static show(t){let e=new a(t);return e.open(),e}};function D(){let a="pages-template-styles";if(document.getElementById(a))return;let t=document.createElement("style");t.id=a,t.textContent=S,document.head.appendChild(t)}typeof window<"u"&&(D(),window.PagesTemplate={Widget:y,Router:x,State:w,getState:C,components:{LoginPage:b,IndexPage:u,InvestmentPage:f,Modal:L}},window.Widget=y,console.log("Pages Template loaded."));export{u as IndexPage,f as InvestmentPage,b as LoginPage,L as Modal,x as Router,w as State,y as Widget,C as getState};
