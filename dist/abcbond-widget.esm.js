...
`;function i(s,t={}){let e=document.createElement(s);return Object.keys(t).forEach(n=>{n==="className"?e.className=t[n]:n==="innerHTML"?e.innerHTML=t[n]:n==="style"&&typeof t[n]=="object"?Object.assign(e.style,t[n]):n==="dataset"?Object.keys(t[n]).forEach(o=>{e.dataset[o]=t[n][o]}):e.setAttribute(n,t[n])}),e}var M="https://abcbond-api.sixman-joseph.workers.dev";async function z(s,t={}){try{let e={"Content-Type":"application/json",...t.headers},n=await fetch(`${M}${s}`,{...t,headers:e});if(!n.ok){let r=await n.json().catch(()=>({}));throw new Error(r.message||`HTTP error! status: ${n.status}`)}return await n.json()}catch(e){throw console.error("API call failed:",e),e}}async function S(){try{let s=await z("/investments");return s.success?s.data:[]}catch(s){throw console.error("Failed to fetch investments:",s),s}}async function $(s){try{let t=await z(`/investments/${s}`);return t.success?t.data:null}catch(t){throw console.error("Failed to fetch investment detail:",t),t}}var m=class{constructor(t={}){this.props=t,this.investments=[],this.onInvestmentClick=t.onInvestmentClick||(()=>{}),this.state=t.state}async loadInvestments(){try{let t=await S();return this.investments=t.map(e=>({id:e.id,name:e.name,location:e.location,totalAmount:e.total_amount,expectedReturn:e.expected_return,status:e.status,type:e.type,image:e.image||"https://via.placeholder.com/400x300?text=No+Image",startDate:e.start_date,endDate:e.end_date})),this.investments}catch(t){throw console.error("Failed to load investments:",t),t}}render(){let t=i("div",{className:"investment-list-container"});return this.loadInvestments().then(()=>{t.innerHTML="";let e=this.renderInvestmentList();t.appendChild(e)}).catch(e=>{t.innerHTML="";let n=i("div",{className:"widget-error",innerHTML:`\uD22C\uC790 \uC0C1\uD488\uC744 \uBD88\uB7EC\uC624\uB294\uB370 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4: ${e.message}`});t.appendChild(n)}),t}renderInvestmentList(){let t=i("div",{className:"investment-wrapper"}),e=i("div",{className:"investment-list-header"}),n=i("h2",{className:"investment-list-title",innerHTML:"\uD22C\uC790 \uC0C1\uD488 \uBAA9\uB85D"});e.appendChild(n),t.appendChild(e);let o=i("div",{className:"investment-list"});return this.investments.forEach(r=>{let a=this.renderInvestmentCard(r);o.appendChild(a)}),t.appendChild(o),t}renderInvestmentCard(t){let e=i("div",{className:"investment-card"});return e.innerHTML=`
    ...
    `;let a=r.querySelector("tbody"),l=0;return this.investment.monthlyInterest.forEach(c=>{l+=c.amount;let g=i("tr");g.innerHTML=`
        <td>${c.month}</td>
        <td class="amount">${c.amount.toLocaleString("ko-KR")}\uC6D0</td>
        <td class="cumulative">${l.toLocaleString("ko-KR")}\uC6D0</td>
      `,a.appendChild(g)}),t.appendChild(r),t}renderPropertyInfo(){let t=i("div",{className:"investment-section"}),e=i("h2",{className:"section-title",innerHTML:"\uBB3C\uAC74 \uC815\uBCF4"});t.appendChild(e);let n=i("table",{className:"property-info-table"}),o=this.investment.details,r=[["\uAC74\uBB3C \uC720\uD615",o.buildingType],["\uC804\uCCB4 \uC138\uB300\uC218",o.totalUnits+"\uC138\uB300"],["\uC900\uACF5\uC5F0\uB3C4",o.buildYear+"\uB144"],["\uC804\uC6A9\uBA74\uC801",o.area],["\uCE35\uC218",o.floor],["\uBC29\uD5A5",o.direction],["\uC8FC\uCC28",o.parking],["\uB09C\uBC29",o.heating]],a=i("tbody");return r.forEach(([l,c])=>{let g=i("tr");g.innerHTML=`
        <th>${l}</th>
        <td>${c}</td>
      `,a.appendChild(g)}),n.appendChild(a),t.appendChild(n),t}renderRegistrationDocument(){let t=i("div",{className:"registration-document-section"}),e=i("h2",{className:"section-title",innerHTML:"\uB4F1\uAE30\uBD80\uB4F1\uBCF8"});t.appendChild(e);let n=this.investment.registrationDocument,o=i("div",{className:"reg-issue-date"});o.innerHTML=`<strong>\uBC1C\uAE09\uC77C\uC790:</strong> ${n.issueDate}`,t.appendChild(o);let r=i("div",{className:"reg-section"}),a=i("h3",{className:"reg-section-title",innerHTML:"\uD45C\uC81C\uBD80 (\uBB3C\uAC74 \uC815\uBCF4)"});r.appendChild(a);let l=i("table",{className:"reg-table"}),c=[["\uC18C\uC7AC\uC9C0",n.propertyInfo.address],["\uAC74\uBB3C\uBA85",n.propertyInfo.buildingName],["\uAC74\uBB3C \uC720\uD615",n.propertyInfo.buildingType],["\uAD6C\uC870",n.propertyInfo.structure],["\uCE35\uC218",n.propertyInfo.floors],["\uC804\uCCB4 \uBA74\uC801",n.propertyInfo.totalArea],["\uC900\uACF5\uC77C",n.propertyInfo.buildDate]],g=i("tbody");c.forEach(([p,h])=>{let d=i("tr");d.innerHTML=`
        <th>${p}</th>
        <td>${h}</td>
      `,g.appendChild(d)}),l.appendChild(g),r.appendChild(l),t.appendChild(r);let C=i("div",{className:"reg-section"}),E=i("h3",{className:"reg-section-title",innerHTML:"\uAC11\uAD6C (\uC18C\uC720\uAD8C \uC815\uBCF4)"});C.appendChild(E);let L=i("table",{className:"reg-table"}),H=[["\uC18C\uC720\uC790",n.ownershipInfo.owner],["\uB4F1\uAE30\uC77C\uC790",n.ownershipInfo.registrationDate],["\uB4F1\uAE30\uC6D0\uC778",n.ownershipInfo.registrationCause],["\uC9C0\uBD84",n.ownershipInfo.shareRatio]],T=i("tbody");if(H.forEach(([p,h])=>{let d=i("tr");d.innerHTML=`
        <th>${p}</th>
        <td>${h}</td>
      `,T.appendChild(d)}),L.appendChild(T),C.appendChild(L),t.appendChild(C),n.rightsInfo&&n.rightsInfo.length>0){let p=i("div",{className:"reg-section"}),h=i("h3",{className:"reg-section-title",innerHTML:"\uAD8C\uB9AC\uC0AC\uD56D (\uAC11\uAD6C)"});p.appendChild(h),n.rightsInfo.forEach((d,k)=>{let x=i("div",{className:"reg-right-box"});x.innerHTML=`
        ...
        `,p.appendChild(x)}),t.appendChild(p)}if(n.restrictionsInfo&&n.restrictionsInfo.length>0){let p=i("div",{className:"reg-section"}),h=i("h3",{className:"reg-section-title",innerHTML:"\uC744\uAD6C (\uC81C\uD55C\uC0AC\uD56D)"});p.appendChild(h),n.restrictionsInfo.forEach((d,k)=>{let x=i("div",{className:"reg-restriction-box"});x.innerHTML=`
