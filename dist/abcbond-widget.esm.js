...
`;function i(d,t={}){let e=document.createElement(d);return Object.keys(t).forEach(n=>{n==="className"?e.className=t[n]:n==="innerHTML"?e.innerHTML=t[n]:n==="style"&&typeof t[n]=="object"?Object.assign(e.style,t[n]):n==="dataset"?Object.keys(t[n]).forEach(o=>{e.dataset[o]=t[n][o]}):e.setAttribute(n,t[n])}),e}var R="./mock-api";async function T(d){try{let t=await fetch(`${R}/${d}`);if(!t.ok)throw new Error(`HTTP error! status: ${t.status}`);return await t.json()}catch(t){throw console.error("API call failed:",t),t}}async function E(){return T("investments.json")}async function H(d){return T("investment-detail.json").then(t=>t[d.toString()])}async function j(){return T("users.json")}async function $(d,t){try{let n=(await j()).find(o=>o.username===d&&o.password===t);if(n){let{password:o,...r}=n;return r}return null}catch(e){throw console.error("Login failed:",e),e}}var f=class{constructor(t={}){this.props=t,this.onLoginSuccess=t.onLoginSuccess||(()=>{}),this.state=t.state,this.error=null,this.isLoading=!1}render(){let t=i("div",{className:"login-container"}),e=i("div",{className:"login-box"}),n=i("div",{className:"login-header"});n.innerHTML=`
    ...
    `;let s=r.querySelector("tbody"),a=0;return this.investment.monthlyInterest.forEach(c=>{a+=c.amount;let g=i("tr");g.innerHTML=`
        <td>${c.month}</td>
        <td class="amount">${c.amount.toLocaleString("ko-KR")}\uC6D0</td>
        <td class="cumulative">${a.toLocaleString("ko-KR")}\uC6D0</td>
      `,s.appendChild(g)}),t.appendChild(r),t}renderPropertyInfo(){let t=i("div",{className:"investment-section"}),e=i("h2",{className:"section-title",innerHTML:"\uBB3C\uAC74 \uC815\uBCF4"});t.appendChild(e);let n=i("table",{className:"property-info-table"}),o=this.investment.details,r=[["\uAC74\uBB3C \uC720\uD615",o.buildingType],["\uC804\uCCB4 \uC138\uB300\uC218",o.totalUnits+"\uC138\uB300"],["\uC900\uACF5\uC5F0\uB3C4",o.buildYear+"\uB144"],["\uC804\uC6A9\uBA74\uC801",o.area],["\uCE35\uC218",o.floor],["\uBC29\uD5A5",o.direction],["\uC8FC\uCC28",o.parking],["\uB09C\uBC29",o.heating]],s=i("tbody");return r.forEach(([a,c])=>{let g=i("tr");g.innerHTML=`
        <th>${a}</th>
        <td>${c}</td>
      `,s.appendChild(g)}),n.appendChild(s),t.appendChild(n),t}renderRegistrationDocument(){let t=i("div",{className:"registration-document-section"}),e=i("h2",{className:"section-title",innerHTML:"\uB4F1\uAE30\uBD80\uB4F1\uBCF8"});t.appendChild(e);let n=this.investment.registrationDocument,o=i("div",{className:"reg-issue-date"});o.innerHTML=`<strong>\uBC1C\uAE09\uC77C\uC790:</strong> ${n.issueDate}`,t.appendChild(o);let r=i("div",{className:"reg-section"}),s=i("h3",{className:"reg-section-title",innerHTML:"\uD45C\uC81C\uBD80 (\uBB3C\uAC74 \uC815\uBCF4)"});r.appendChild(s);let a=i("table",{className:"reg-table"}),c=[["\uC18C\uC7AC\uC9C0",n.propertyInfo.address],["\uAC74\uBB3C\uBA85",n.propertyInfo.buildingName],["\uAC74\uBB3C \uC720\uD615",n.propertyInfo.buildingType],["\uAD6C\uC870",n.propertyInfo.structure],["\uCE35\uC218",n.propertyInfo.floors],["\uC804\uCCB4 \uBA74\uC801",n.propertyInfo.totalArea],["\uC900\uACF5\uC77C",n.propertyInfo.buildDate]],g=i("tbody");c.forEach(([p,h])=>{let l=i("tr");l.innerHTML=`
        <th>${p}</th>
        <td>${h}</td>
      `,g.appendChild(l)}),a.appendChild(g),r.appendChild(a),t.appendChild(r);let L=i("div",{className:"reg-section"}),M=i("h3",{className:"reg-section-title",innerHTML:"\uAC11\uAD6C (\uC18C\uC720\uAD8C \uC815\uBCF4)"});L.appendChild(M);let N=i("table",{className:"reg-table"}),P=[["\uC18C\uC720\uC790",n.ownershipInfo.owner],["\uB4F1\uAE30\uC77C\uC790",n.ownershipInfo.registrationDate],["\uB4F1\uAE30\uC6D0\uC778",n.ownershipInfo.registrationCause],["\uC9C0\uBD84",n.ownershipInfo.shareRatio]],z=i("tbody");if(P.forEach(([p,h])=>{let l=i("tr");l.innerHTML=`
        <th>${p}</th>
        <td>${h}</td>
      `,z.appendChild(l)}),N.appendChild(z),L.appendChild(N),t.appendChild(L),n.rightsInfo&&n.rightsInfo.length>0){let p=i("div",{className:"reg-section"}),h=i("h3",{className:"reg-section-title",innerHTML:"\uAD8C\uB9AC\uC0AC\uD56D (\uAC11\uAD6C)"});p.appendChild(h),n.rightsInfo.forEach((l,k)=>{let x=i("div",{className:"reg-right-box"});x.innerHTML=`
