...
`;function i(s,t={}){let e=document.createElement(s);return Object.keys(t).forEach(n=>{n==="className"?e.className=t[n]:n==="innerHTML"?e.innerHTML=t[n]:n==="style"&&typeof t[n]=="object"?Object.assign(e.style,t[n]):n==="dataset"?Object.keys(t[n]).forEach(o=>{e.dataset[o]=t[n][o]}):e.setAttribute(n,t[n])}),e}var M="https://abcbond-api.sixman-joseph.workers.dev";async function z(s,t={}){try{let e={"Content-Type":"application/json",...t.headers},n=await fetch(`${M}${s}`,{...t,headers:e});if(!n.ok){let r=await n.json().catch(()=>({}));throw new Error(r.message||`HTTP error! status: ${n.status}`)}return await n.json()}catch(e){throw console.error("API call failed:",e),e}}async function S(){try{let s=await z("/investments");return s.success?s.data:[]}catch(s){throw console.error("Failed to fetch investments:",s),s}}async function $(s){try{let t=await z(`/investments/${s}`);return t.success?t.data:null}catch(t){throw console.error("Failed to fetch investment detail:",t),t}}var m=class{constructor(t={}){this.props=t,this.investments=[],this.onInvestmentClick=t.onInvestmentClick||(()=>{}),this.state=t.state}async loadInvestments(){try{let t=await S();return this.investments=t.map(e=>({id:e.id,name:e.name,location:e.location,totalAmount:e.total_amount,expectedReturn:e.expected_return,status:e.status,type:e.type,image:e.image||"https://via.placeholder.com/400x300?text=No+Image",startDate:e.start_date,endDate:e.end_date})),this.investments}catch(t){throw console.error("Failed to load investments:",t),t}}render(){let t=i("div",{className:"investment-list-container"});return this.loadInvestments().then(()=>{t.innerHTML="";let e=this.renderInvestmentList();t.appendChild(e)}).catch(e=>{t.innerHTML="";let n=i("div",{className:"widget-error",innerHTML:`\uD22C\uC790 \uC0C1\uD488\uC744 \uBD88\uB7EC\uC624\uB294\uB370 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4: ${e.message}`});t.appendChild(n)}),t}renderInvestmentList(){let t=i("div",{className:"investment-wrapper"}),e=i("div",{className:"investment-list-header"}),n=i("h2",{className:"investment-list-title",innerHTML:"\uD22C\uC790 \uC0C1\uD488 \uBAA9\uB85D"});e.appendChild(n),t.appendChild(e);let o=i("div",{className:"investment-list"});return this.investments.forEach(r=>{let a=this.renderInvestmentCard(r);o.appendChild(a)}),t.appendChild(o),t}renderInvestmentCard(t){let e=i("div",{className:"investment-card"});return e.innerHTML=`
      <div class="investment-image">
        <img src="${t.image}" alt="${t.name}">
        <span class="investment-status ${t.status}">${t.status==="active"?"\uBAA8\uC9D1 \uC911":t.status==="completed"?"\uC644\uB8CC":"\uCDE8\uC18C"}</span>
      </div>
      <div class="investment-info">
        ...
        <div class="investment-amount">
          ...
          <span class="value">${t.totalAmount.toLocaleString("ko-KR")}\uC6D0</span>
        </div>
    ...
    `,t.appendChild(o),t}renderTabSection(){let t=i("div",{className:"investment-tab-section"}),e=i("div",{className:"tab-buttons"}),n=i("button",{className:`tab-btn ${this.currentTab==="detail"?"active":""}`,innerHTML:"\uC0C1\uC138\uC815\uBCF4 / \uBB3C\uAC74\uC815\uBCF4"});n.addEventListener("click",()=>this.switchTab("detail",t));let o=i("button",{className:`tab-btn ${this.currentTab==="interest"?"active":""}`,innerHTML:"\uC6D4\uBCC4 \uC774\uC790 \uC9C0\uAE09 \uB0B4\uC5ED"});o.addEventListener("click",()=>this.switchTab("interest",t));let r=i("button",{className:`tab-btn ${this.currentTab==="registration"?"active":""}`,innerHTML:"\uB4F1\uAE30\uBD80\uB4F1\uBCF8"});r.addEventListener("click",()=>this.switchTab("registration",t)),e.appendChild(n),e.appendChild(o),e.appendChild(r),t.appendChild(e);let a=i("div",{className:"tab-content"});return a.appendChild(this.renderTabContent()),t.appendChild(a),t}switchTab(t,e){this.currentTab=t;let n=e.querySelectorAll(".tab-btn");n.forEach(a=>a.classList.remove("active")),n[t==="detail"?0:t==="interest"?1:2].classList.add("active");let r=e.querySelector(".tab-content");r.innerHTML="",r.appendChild(this.renderTabContent())}renderTabContent(){let t=i("div",{className:"tab-content-container"});return this.currentTab==="detail"?(t.appendChild(this.renderDescription()),t.appendChild(this.renderPropertyInfo())):this.currentTab==="interest"?t.appendChild(this.renderMonthlyInterest()):this.currentTab==="registration"&&t.appendChild(this.renderRegistrationDocument()),t}renderImageGallery(){let t=i("div",{className:"investment-gallery"}),e=i("div",{className:"gallery-main"}),n=i("img",{src:this.investment.images[this.currentImageIndex],alt:this.investment.name});e.appendChild(n),t.appendChild(e);let o=i("div",{className:"gallery-thumbnails"});return this.investment.images.forEach((r,a)=>{let d=i("img",{src:r,alt:`${this.investment.name} ${a+1}`,className:a===this.currentImageIndex?"active":""});d.addEventListener("click",()=>{this.currentImageIndex=a,n.src=r,o.querySelectorAll("img").forEach(c=>c.classList.remove("active")),d.classList.add("active")}),o.appendChild(d)}),t.appendChild(o),t}renderDescription(){let t=i("div",{className:"investment-section"}),e=i("h2",{className:"section-title",innerHTML:"\uC0C1\uC138 \uC124\uBA85"});t.appendChild(e);let n=i("p",{className:"investment-description",innerHTML:this.investment.description});return t.appendChild(n),t}renderMonthlyInterest(){let t=i("div",{className:"investment-section"}),e=i("h2",{className:"section-title",innerHTML:"\uC6D4\uBCC4 \uC774\uC790 \uC9C0\uAE09 \uB0B4\uC5ED"});t.appendChild(e);let n=this.investment.monthlyInterest.reduce((c,g)=>c+g.amount,0),o=i("div",{className:"interest-summary"});o.innerHTML=`
    ...
    `;let a=r.querySelector("tbody"),d=0;return this.investment.monthlyInterest.forEach(c=>{d+=c.amount;let g=i("tr");g.innerHTML=`
        <td>${c.month}</td>
        <td class="amount">${c.amount.toLocaleString("ko-KR")}\uC6D0</td>
        <td class="cumulative">${d.toLocaleString("ko-KR")}\uC6D0</td>
      `,a.appendChild(g)}),t.appendChild(r),t}renderPropertyInfo(){let t=i("div",{className:"investment-section"}),e=i("h2",{className:"section-title",innerHTML:"\uBB3C\uAC74 \uC815\uBCF4"});t.appendChild(e);let n=i("table",{className:"property-info-table"}),o=this.investment.details,r=[["\uAC74\uBB3C \uC720\uD615",o.buildingType],["\uC804\uCCB4 \uC138\uB300\uC218",o.totalUnits+"\uC138\uB300"],["\uC900\uACF5\uC5F0\uB3C4",o.buildYear+"\uB144"],["\uC804\uC6A9\uBA74\uC801",o.area],["\uCE35\uC218",o.floor],["\uBC29\uD5A5",o.direction],["\uC8FC\uCC28",o.parking],["\uB09C\uBC29",o.heating]],a=i("tbody");return r.forEach(([d,c])=>{let g=i("tr");g.innerHTML=`
        <th>${d}</th>
        <td>${c}</td>
      `,a.appendChild(g)}),n.appendChild(a),t.appendChild(n),t}renderRegistrationDocument(){let t=i("div",{className:"registration-document-section"}),e=i("h2",{className:"section-title",innerHTML:"\uB4F1\uAE30\uBD80\uB4F1\uBCF8"});t.appendChild(e);let n=this.investment.registrationDocument,o=i("div",{className:"reg-issue-date"});o.innerHTML=`<strong>\uBC1C\uAE09\uC77C\uC790:</strong> ${n.issueDate}`,t.appendChild(o);let r=i("div",{className:"reg-section"}),a=i("h3",{className:"reg-section-title",innerHTML:"\uD45C\uC81C\uBD80 (\uBB3C\uAC74 \uC815\uBCF4)"});r.appendChild(a);let d=i("table",{className:"reg-table"}),c=[["\uC18C\uC7AC\uC9C0",n.propertyInfo.address],["\uAC74\uBB3C\uBA85",n.propertyInfo.buildingName],["\uAC74\uBB3C \uC720\uD615",n.propertyInfo.buildingType],["\uAD6C\uC870",n.propertyInfo.structure],["\uCE35\uC218",n.propertyInfo.floors],["\uC804\uCCB4 \uBA74\uC801",n.propertyInfo.totalArea],["\uC900\uACF5\uC77C",n.propertyInfo.buildDate]],g=i("tbody");c.forEach(([p,h])=>{let l=i("tr");l.innerHTML=`
        <th>${p}</th>
        <td>${h}</td>
      `,g.appendChild(l)}),d.appendChild(g),r.appendChild(d),t.appendChild(r);let C=i("div",{className:"reg-section"}),E=i("h3",{className:"reg-section-title",innerHTML:"\uAC11\uAD6C (\uC18C\uC720\uAD8C \uC815\uBCF4)"});C.appendChild(E);let L=i("table",{className:"reg-table"}),H=[["\uC18C\uC720\uC790",n.ownershipInfo.owner],["\uB4F1\uAE30\uC77C\uC790",n.ownershipInfo.registrationDate],["\uB4F1\uAE30\uC6D0\uC778",n.ownershipInfo.registrationCause],["\uC9C0\uBD84",n.ownershipInfo.shareRatio]],T=i("tbody");if(H.forEach(([p,h])=>{let l=i("tr");l.innerHTML=`
        <th>${p}</th>
        <td>${h}</td>
      `,T.appendChild(l)}),L.appendChild(T),C.appendChild(L),t.appendChild(C),n.rightsInfo&&n.rightsInfo.length>0){let p=i("div",{className:"reg-section"}),h=i("h3",{className:"reg-section-title",innerHTML:"\uAD8C\uB9AC\uC0AC\uD56D (\uAC11\uAD6C)"});p.appendChild(h),n.rightsInfo.forEach((l,k)=>{let x=i("div",{className:"reg-right-box"});x.innerHTML=`
          <div class="reg-right-item"><strong>\uC21C\uC704\uBC88\uD638:</strong> ${k+1}</div>
          <div class="reg-right-item"><strong>\uAD8C\uB9AC\uC885\uB958:</strong> ${l.type}</div>
          <div class="reg-right-item"><strong>\uAD8C\uB9AC\uC790:</strong> ${l.holder}</div>
          <div class="reg-right-item"><strong>\uB4F1\uAE30\uC77C\uC790:</strong> ${l.registrationDate}</div>
          <div class="reg-right-item"><strong>\uB4F1\uAE30\uBAA9\uC801:</strong> ${l.purpose}</div>
        `,p.appendChild(x)}),t.appendChild(p)}if(n.restrictionsInfo&&n.restrictionsInfo.length>0){let p=i("div",{className:"reg-section"}),h=i("h3",{className:"reg-section-title",innerHTML:"\uC744\uAD6C (\uC81C\uD55C\uC0AC\uD56D)"});p.appendChild(h),n.restrictionsInfo.forEach((l,k)=>{let x=i("div",{className:"reg-restriction-box"});x.innerHTML=`
          <div class="reg-restriction-item"><strong>\uC21C\uC704\uBC88\uD638:</strong> ${k+1}</div>
          <div class="reg-restriction-item"><strong>\uAD8C\uB9AC\uC885\uB958:</strong> ${l.type}</div>
          <div class="reg-restriction-item"><strong>\uAD8C\uB9AC\uC790:</strong> ${l.holder}</div>
          <div class="reg-restriction-item"><strong>\uCC44\uAD8C\uCD5C\uACE0\uC561:</strong> ${l.amount.toLocaleString()}\uC6D0</div>
          <div class="reg-restriction-item"><strong>\uB4F1\uAE30\uC77C\uC790:</strong> ${l.registrationDate}</div>
          <div class="reg-restriction-item"><strong>\uB4F1\uAE30\uBAA9\uC801:</strong> ${l.purpose}</div>
        `,p.appendChild(x)}),t.appendChild(p)}return t}};var f=class{constructor(t={}){this.routes=t,this.currentRoute=null,this.currentPath=null,this.pathParams={},this.isNavigating=!1,this.loadingTimeout=null,this.beforeNavigate=null,this.handlePopState=this.handlePopState.bind(this),window.addEventListener("popstate",this.handlePopState),this.handleHashChange=this.handleHashChange.bind(this),window.addEventListener("hashchange",this.handleHashChange)}addRoute(t,e){this.routes[t]=e}addRoutes(t){this.routes={...this.routes,...t}}getHash(){return window.location.hash.slice(1)||"/"}extractParams(t,e){let n=t.split("/"),o=e.split("/");if(n.length!==o.length)return null;let r={};for(let a=0;a<n.length;a++)if(n[a].startsWith(":")){let d=n[a].slice(1);r[d]=decodeURIComponent(o[a])}else if(n[a]!==o[a])return null;return r}matchRoute(t){if(this.routes[t])return{handler:this.routes[t],params:{}};for(let e in this.routes){if(e==="*")continue;let n=this.extractParams(e,t);if(n!==null)return{handler:this.routes[e],params:n}}return this.routes["*"]?{handler:this.routes["*"],params:{}}:null}async handleRoute(){if(this.isNavigating)return;let t=this.getHash(),e=this.matchRoute(t);if(!e){console.warn("No route handler found for:",t);return}this.isNavigating=!0;try{this.loadingTimeout=setTimeout(()=>{this.showLoadingIndicator()},1e3),this.beforeNavigate&&await this.beforeNavigate(t,e.params),clearTimeout(this.loadingTimeout),this.hideLoadingIndicator(),this.currentRoute=t,this.currentPath=t,this.pathParams=e.params,e.handler(e.params)}catch(n){console.error("Route handling error:",n),clearTimeout(this.loadingTimeout),this.hideLoadingIndicator()}finally{this.isNavigating=!1}}handlePopState(){this.handleRoute()}handleHashChange(){this.handleRoute()}showLoadingIndicator(){if(document.querySelector(".router-loading-indicator"))return;let e=document.createElement("div");e.className="router-loading-indicator",e.innerHTML='<div class="spinner"></div>',document.body.appendChild(e)}hideLoadingIndicator(){let t=document.querySelector(".router-loading-indicator");t&&t.remove()}setBeforeNavigate(t){this.beforeNavigate=t}navigate(t,e={}){window.history.pushState(e,"",`#${t}`),this.handleRoute()}redirect(t,e={}){window.history.replaceState(e,"",`#${t}`),this.handleRoute()}back(){window.history.back()}forward(){window.history.forward()}getCurrentRoute(){return{fullPath:this.currentRoute,path:this.currentPath,params:this.pathParams,hash:this.getHash()}}getParam(t){return t?this.pathParams[t]:{...this.pathParams}}isRoute(t){return this.currentPath===t}destroy(){window.removeEventListener("popstate",this.handlePopState),window.removeEventListener("hashchange",this.handleHashChange)}init(){this.handleRoute()}};var b=class{constructor(){this.state={user:null,token:null,currentView:null},this.listeners=new Map}getState(t){return t?this.state[t]:{...this.state}}setState(t){let e={...this.state};this.state={...this.state,...t},Object.keys(t).forEach(n=>{this.notify(n,this.state[n],e[n])}),this.notify("*",this.state,e)}subscribe(t,e){return this.listeners.has(t)||this.listeners.set(t,[]),this.listeners.get(t).push(e),()=>{let n=this.listeners.get(t),o=n.indexOf(e);o>-1&&n.splice(o,1)}}notify(t,e,n){(this.listeners.get(t)||[]).forEach(r=>{r(e,n)})}setUser(t){this.setState({user:t})}getUser(){return this.state.user}isAuthenticated(){return this.state.user!==null}logout(){this.setState({user:null,token:null});try{localStorage.removeItem("widget-state")}catch(t){console.warn("Failed to remove state from localStorage:",t)}this.notify("auth:logout")}setCurrentView(t){this.setState({currentView:t})}reset(){this.state={user:null,token:null,currentView:null},this.notify("*",this.state,{})}saveToStorage(){try{localStorage.setItem("widget-state",JSON.stringify({user:this.state.user,token:this.state.token}))}catch(t){console.warn("Failed to save state to localStorage:",t)}}loadFromStorage(){try{let t=localStorage.getItem("widget-state");if(t){let e=JSON.parse(t);this.setState({user:e.user||null,token:e.token||null})}}catch(t){console.warn("Failed to load state from localStorage:",t)}}},I=null;function w(){return I||(I=new b),I}var v=class{constructor(t,e={}){this.container=t||"#widget-root",this.config=e,this.currentView=null,this.state=w(),this.router=new f,this.setupRoutes(),this.init()}setupRoutes(){this.router.addRoutes({"/":()=>this.showInvestmentList(),"/investment/:id":t=>this.showInvestmentDetail(t),"*":()=>this.showInvestmentList()})}init(){if(console.log("Widget initialized with config:",this.config),!this.getContainer()){console.error("Container not found:",this.container);return}this.router.setBeforeNavigate(async(e,n)=>{await this.preloadPage(e,n)}),this.router.init()}async preloadPage(t,e){if(t==="/")await new m({state:this.state}).loadInvestments();else if(t.startsWith("/investment/")){let n=parseInt(e.id);n&&await new u({investmentId:n,state:this.state}).loadInvestment()}}getContainer(){return typeof this.container=="string"?document.querySelector(this.container):this.container}showInvestmentList(){let t=this.getContainer();if(!t)return;this.state.setCurrentView("investment-list");let n=new m({state:this.state,onInvestmentClick:o=>{this.router.navigate(`/investment/${o.id}`)}}).render();this.transitionToPage(t,n)}showInvestmentDetail(t){let e=this.getContainer();if(!e)return;let n=parseInt(t.id);if(!n){console.error("Investment ID is required"),this.router.navigate("/");return}this.state.setCurrentView("investment-detail");let r=new u({investmentId:n,state:this.state,onBack:()=>{this.router.back()}}).render();this.transitionToPage(e,r)}transitionToPage(t,e){let n=t.firstElementChild;e.style.opacity="0",e.style.transition="opacity 0.05s ease-in-out",n?(n.style.transition="opacity 0.05s ease-in-out",n.style.opacity="0",setTimeout(()=>{t.innerHTML="",t.appendChild(e),setTimeout(()=>{e.style.opacity="1"},10)},50)):(t.appendChild(e),setTimeout(()=>{e.style.opacity="1"},10))}getCurrentRoute(){return this.router.getCurrentRoute()}navigate(t,e={}){this.router.navigate(t,e)}getState(t){return this.state.getState(t)}destroy(){this.router.destroy(),this.config.resetOnDestroy&&this.state.reset();let t=this.getContainer();t&&(t.innerHTML=""),this.currentView=null}};var y=class s{constructor(t={}){this.props=t,this.title=t.title||"",this.content=t.content||"",this.onClose=t.onClose||(()=>{}),this.overlay=null}render(){this.overlay=i("div",{className:"widget-modal-overlay"});let t=i("div",{className:"widget-modal"}),e=i("button",{className:"widget-modal-close",innerHTML:"\xD7"});e.addEventListener("click",()=>this.close());let n=i("h2",{innerHTML:this.title,style:"margin-top: 0;"}),o=i("div",{className:"widget-modal-content"});return typeof this.content=="string"?o.innerHTML=this.content:o.appendChild(this.content),t.appendChild(e),this.title&&t.appendChild(n),t.appendChild(o),this.overlay.appendChild(t),this.overlay.addEventListener("click",r=>{r.target===this.overlay&&this.close()}),this.handleEscKey=r=>{r.key==="Escape"&&this.close()},document.addEventListener("keydown",this.handleEscKey),this.overlay}open(){let t=this.render();document.body.appendChild(t)}close(){this.overlay&&this.overlay.parentNode&&this.overlay.parentNode.removeChild(this.overlay),document.removeEventListener("keydown",this.handleEscKey),this.onClose()}static show(t){let e=new s(t);return e.open(),e}};function P(){let s="pages-template-styles";if(document.getElementById(s))return;let t=document.createElement("style");t.id=s,t.textContent=N,document.head.appendChild(t)}typeof window<"u"&&(P(),window.PagesTemplate={Widget:v,Router:f,State:b,getState:w,components:{IndexPage:m,InvestmentPage:u,Modal:y}},window.Widget=v,console.log("Pages Template loaded."));export{m as IndexPage,u as InvestmentPage,y as Modal,f as Router,b as State,v as Widget,w as getState};
